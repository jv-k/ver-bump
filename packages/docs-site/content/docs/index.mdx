...
| Interactive with a smart suggestion | ✅ | ✅ | ❌ CI-only | ❌ PR-driven | ⚠️ intent files |
| Dry-run preview of every side-effect | ✅ `--dry-run` (+ `--json`) | ✅ | ⚠️ | n/a | ⚠️ |
| Local undo before pushing | ✅ `--undo` | ❌ | ❌ | n/a | ❌ |
| Monorepo: per-package tags | ✅ [`TAG_PREFIX`](/docs/guides/monorepos) | ✅ | ⚠️ plugins | ✅ | ✅ |
| Monorepo: scoped suggestion + changelog | ✅ [`COMMIT_PATHS`](/docs/guides/monorepos) | ⚠️ partial | ⚠️ plugins | ✅ | ✅ |
| Monorepo: scoped release notes | ✅ | ❌ | ⚠️ | ✅ | ✅ |
| Monorepo-aware dirty-tree check | ✅ | ❌ | n/a | n/a | ❌ |
| Workspace dependency-graph bumping | ❌ by design | ❌ | ⚠️ plugins | ⚠️ partial | ✅ |
| "Release everything that changed" | ❌ [your scripts](/docs/guides/monorepos) | ❌ | ✅ per-package CI | ✅ release PR | ✅ |
...
| **Monorepo packages** | Per-package tag series and path-scoped commit analysis: run VerBump from a package dir and the suggestion, changelog, and release notes cover only that package. |
